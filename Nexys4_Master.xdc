...
#set_property PACKAGE_PIN U9 [get_ports control1[0]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports control1[0]]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
#set_property PACKAGE_PIN U8 [get_ports control1[1]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports control1[1]]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
#set_property PACKAGE_PIN R7 [get_ports control2[0]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports control2[0]]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
#set_property PACKAGE_PIN R6 [get_ports control2[1]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports control2[1]]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
#set_property PACKAGE_PIN R5 [get_ports MRGB[1]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports MRGB[1]]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
#set_property PACKAGE_PIN V7 [get_ports MRGB[2]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports MRGB[2]]
...
#set_property PACKAGE_PIN R3 [get_ports {size[0]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {size[0]}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
#set_property PACKAGE_PIN P3 [get_ports {size[1]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {size[1]}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
#set_property PACKAGE_PIN P4 [get_ports size[2]]					
	#set_property IOSTANDARD LVCMOS33 [get_ports size[2]]
...
#set_property PACKAGE_PIN T8 [get_ports colicion_led]					
	#set_property IOSTANDARD LVCMOS33 [get_ports colicion_led]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
#set_property PACKAGE_PIN V9 [get_ports colicion_led]					
	#set_property IOSTANDARD LVCMOS33 [get_ports colicion_led]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
#set_property PACKAGE_PIN R8 [get_ports colicion_led]					
	#set_property IOSTANDARD LVCMOS33 [get_ports colicion_led]
...
set_property PACKAGE_PIN E16 [get_ports btn_next]						
...
set_property PACKAGE_PIN R10 [get_ports btn_control]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_control]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports btn_dowm]						
	set_property IOSTANDARD LVCMOS33 [get_ports btn_dowm]
...
set_property PACKAGE_PIN A3 [get_ports RGB_VGA[2]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[2]]
##Bank = 35, Pin name = IO_L7N_T1_AD6N_35,					Sch name = VGA_R1
set_property PACKAGE_PIN B4 [get_ports RGB_VGA[2]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[2]]
...
set_property PACKAGE_PIN A4 [get_ports RGB_VGA[2]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[2]]
##Bank = 35, Pin name = IO_L2P_T0_AD12P_35,					Sch name = VGA_B0
set_property PACKAGE_PIN B7 [get_ports RGB_VGA[1]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[1]]
##Bank = 35, Pin name = IO_L4N_T0_35,						Sch name = VGA_B1
set_property PACKAGE_PIN C7 [get_ports RGB_VGA[1]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[1]]
##Bank = 35, Pin name = IO_L6N_T0_VREF_35,					Sch name = VGA_B2
set_property PACKAGE_PIN D7 [get_ports RGB_VGA[1]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[1]]
##Bank = 35, Pin name = IO_L4P_T0_35,						Sch name = VGA_B3
set_property PACKAGE_PIN D8 [get_ports RGB_VGA[1]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[1]]
##Bank = 35, Pin name = IO_L1P_T0_AD4P_35,					Sch name = VGA_G0
set_property PACKAGE_PIN C6 [get_ports RGB_VGA[0]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[0]]
##Bank = 35, Pin name = IO_L3N_T0_DQS_AD5N_35,				Sch name = VGA_G1
set_property PACKAGE_PIN A5 [get_ports RGB_VGA[0]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[0]]
##Bank = 35, Pin name = IO_L2N_T0_AD12N_35,					Sch name = VGA_G2
set_property PACKAGE_PIN B6 [get_ports RGB_VGA[0]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[0]]
##Bank = 35, Pin name = IO_L3P_T0_DQS_AD5P_35,				Sch name = VGA_G3
set_property PACKAGE_PIN A6 [get_ports RGB_VGA[0]]				
	set_property IOSTANDARD LVCMOS33 [get_ports RGB_VGA[0]]
